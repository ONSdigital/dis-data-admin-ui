...
export const updateDistributionsMetadata = async (reqCfg, distributions = [], datasetId, edition, version) => {
    const updatePromises = distributions.map(async (distribution) => {
