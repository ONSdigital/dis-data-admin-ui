...
export default function VersionForm({ datasetID, editionID, version, isNewVersion, action, accessToken }) {
    ...
    return (
        <>    
            ...
            <form action={formAction}>
                ...
                <VersionFields fieldValues={version} errors={formState.errors} accessToken={accessToken} />
