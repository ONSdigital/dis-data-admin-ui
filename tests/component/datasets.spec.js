...
test.describe('series', () => {
    ...
    test("Choose a fully populated dataset from a list of datasets and route to chosen dataset page", async ({ page, context }) => {
        ...
        // Should be Business, industry and trade
        await expect(page.getByTestId('topics-field')).toContainText('2945');
        // Should be Census
        await expect(page.getByTestId('topics-field')).toContainText('3161');
